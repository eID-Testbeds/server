...
{
	CHARLENGTH, CREATE_SOAP_SECURITY_HEADER, CREATE_SAML, CREATE_SAML_NO_SIGALG_NO_SIGNATURE, CREATE_SAML_NO_SIGNATURE, UUID, CHAT, AUTHENTICATION_TOKEN, APDU, REFRESHADDRESS_PATH;
