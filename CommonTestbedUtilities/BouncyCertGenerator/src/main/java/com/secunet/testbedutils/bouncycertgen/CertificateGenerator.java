...
public interface CertificateGenerator
{
	 ...
	 * 
	 * @param {@link
	 * 			List<String>} xmlPaths The paths to the XML files that will
	 ...
	 * 
	 * @param {@link
	 * 			String} definition The XML certificate definition string
	 * @return {@link List<X509Certificate>} A list of X509 certificates
	 */
	public List<GeneratedCertificate> makex509Certificate(String definition);

	/**
	 * Create a x509 certificates for the provided certificate definition.
	 * <p>
	 * - The definitions object may contain multiple definition objects. These
	 * will be processed in the list order. For example, if a CA is to be created
	 * and then used to sign sub certificates, it has to be located at a lower
	 * index in the list.
	 * <p>
	 * - If no signature algorithm is provided, SHA256withRSA with a bit length
	 * of 2048 bit will be used.
	 ...
	 * 
	 * @param {@link
	 * 			CertificateDefinitions} definitions The definitions structure containing the specification of the certificates to be created
	 * @return {@link List<X509Certificate>} A list of X509 certificates
	 */
	 ...
	 * 
	 * @param {@link
	 * 			String} path The path to the certificate
	 ...
	 */
	public static CVCertificate cvFromBase64String(String base64Encoded) throws CertificateException, IOException, CVTagNotFoundException, CVBufferNotEmptyException, CVInvalidOidException,
			CVDecodeErrorException, CVInvalidDateException, CVInvalidECPointLengthException
	{
		InputStream stream = new ByteArrayInputStream(Base64Util.decode(base64Encoded));
	...
	public static String cvToBase64String(CVCertificate certificate) throws CertificateEncodingException, IOException
	{
		...
		catch (CVAuthorityRefNotValidException | CVInvalidKeySourceException | CVSignOpKeyMismatchException | CVInvalidOidException | CVMissingKeyException | CVKeyTypeNotSupportedException e)
		{
