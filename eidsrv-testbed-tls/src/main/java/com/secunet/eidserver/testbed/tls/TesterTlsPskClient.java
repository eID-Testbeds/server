...
class TesterTlsPskClient extends PSKTlsClient implements TlsAuthentication
{
	...
	public TesterTlsPskClient(final LogMessageDAO logMessageDAO, final List<LogMessage> result, final TlsTestParameters parameters)
	{
		super(new BasicTlsPSKIdentity(parameters.getPSK()[0],parameters.getPSK()[1]));
	...
	public void processServerExtensions(Hashtable serverExtensions) throws IOException
	{
		...
		if (parameters.getEncryptThenMACExtension())
		{
			...
			if (parameters.getEncryptThenMACExtensionEnabled() == TlsExtensionsUtils.hasEncryptThenMACExtension(serverExtensions))
			{
				msg.setSuccess(true);
